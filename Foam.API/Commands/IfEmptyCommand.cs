...
{
    [ShortDescription("Process subcommands for all files that has a given empty variable.")]
    [LongDescription("Applies a filter to the file list; any subcommands to this command will be executed on any file " +
                     "which variable 'var' is empty. If no such file exists, no subcommands will be executed.")]
    public class IfEmptyCommand : ICompoundCommand
    {
